...
Immense gratitude for the blog post and GH repo from [Jason Watmore - @cornflourblue](https://github.com/cornflourblue) which enabled the JWT-authenticated route handling setup. After scouring dozens of articles and MS documentation pages Jason's simple writing style and minimal but effective code allowed it all to finally click!


<br />
<br />
<p align="center" style="text-align: center;">
  <small>Made with ❤️&nbsp; in Portland, OR, USA</small>
</p>
